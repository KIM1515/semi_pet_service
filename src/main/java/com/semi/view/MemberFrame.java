...
public class MemberFrame extends javax.swing.JFrame implements ActionListener{
    ...
    private void petAdd() throws SQLException{
        ...
        if(petName==null || petName.isEmpty()) {
            JOptionPane.showMessageDialog(this, "펫 이름을 입력하세요");
            tfPetName.requestFocus();
            return;
        }else if(petGender==null || petGender.isEmpty()) {
            JOptionPane.showMessageDialog(this, "펫 성별을 선택하세요");
            cbPetGender.requestFocus();
            return;
        }
